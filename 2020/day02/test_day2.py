...
def test_is_valid_part_1():
    assert is_valid_part_1("1-3 a: abcde") is True
    assert is_valid_part_1("1-3 b: cdefg") is False
    assert is_valid_part_1("2-9 c: ccccccccc") is True


def test_is_valid_part_2():
    assert is_valid_part_2("1-3 a: abcde") is True
    assert is_valid_part_2("1-3 b: cdefg") is False
    assert is_valid_part_2("2-9 c: ccccccccc") is False
